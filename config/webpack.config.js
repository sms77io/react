...
const useTypeScript = fs.existsSync(paths.appTsConfig);// Check if TypeScript is setup
...
// Production and development configuration. Focused on developer experience, fast rebuilds, and a minimal bundle.
module.exports = function (webpackEnv) {
    ...
    const env = getClientEnvironment(publicUrl);  // Get environment variables to inject into our app.
    ...
    return {
        ...
        optimization: {
            ...
            minimizer: [
                new TerserPlugin({        // This is only used in production mode
                    terserOptions: {
                        parse: {
